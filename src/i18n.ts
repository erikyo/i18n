...
class I18n {
	 ...
	 * @returns Locale data.
	 */
	getLocaleData = (domain = "default") =>
		this.tannin.data[domain] as TanninDomainMetadata;
	 ...
	 * @param domain Optional domain parameter.
	 */
	setLocaleData = (data?: LocaleRow, domain = "default") => {
	 ...
	 * @param domain Optional domain parameter.
	 */
	addLocaleData = (data: LocaleRow, domain: string | undefined = "default") => {
		this.tannin.data[domain] = {
			...this.tannin.data[domain],
			...data,
			// Populate default domain configuration (supported locale date which omits
	 ...
	 * @param domain Optional domain parameter.
	 */
	resetLocaleData = (data?: LocaleRow, domain?: string) => {
